 ...
 */
public class BreadthFirstDirectedPathsDemo {
     ...
     */
    public BreadthFirstDirectedPathsDemo(Digraph G, int s) {
     ...
     */
    public BreadthFirstDirectedPathsDemo(Digraph G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
        for (int v = 0; v < G.V(); v++)
...
//        StdOut.println(G);
        ...
        BreadthFirstDirectedPathsDemo bfs = new BreadthFirstDirectedPathsDemo(G, s);
